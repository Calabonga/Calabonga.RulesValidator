...
using Calabonga.RulesValidatorDemo.Web.Extensions;
...
using Calabonga.RulesValidatorDemo.Web.Infrastructure.QueryParams;
...
namespace Calabonga.RulesValidatorDemo.Web.Controllers.Base
{
        ...
        where TUpdateViewModel : IViewModel, IHaveId, new()
    {
        ...
        protected WritableController(
            ...
            : base(entityManager.CurrentMapper, options, unitOfWork)
        {
        ...
        /// <returns></returns>
        private async Task UpdateAuditAsync(TEntity entity)
        {
